...
//    private final String LOGIN_PAGE = "login.html";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String uri = req.getRequestURI(); // /MVC2MYCODE/login
        int lastIndex = uri.lastIndexOf("/"); // 11
        String label = uri.substring(lastIndex + 1);// login    search.jsp
        ...
        try {
            ...
            log("FilterDispatcher _ MissingResourceException : " + e.getMessage());
        }
