...
public class AddItemToCartServlet extends HttpServlet {
    ...
    private final String SHOPPING_PAGE = "OnlineStoreServlet";
        ...
        try {
            ...
            if (session != null) {
                ...
                if (quantity <= 0 || quantity > 50) {
                    request.setAttribute("ERROR_QUANTITY", "Quantity is required inputted from 1 to 50 item");
                    url = ONLINE_STORE_PAGE;
                } else {
            ...
            url = ONLINE_STORE_PAGE;
            request.setAttribute("ERROR_QUANTITY", "Quantity is required inputted from 1 to 50 item");
            log("AddItemToCartServlet _ NumberFormatException : " + ex.getMessage());
        } finally {
